...
O objetivo deste projeto foi construir um sistema de gerenciamento de veículos para uma revenda de automóveis, aplicando os conceitos fundamentais de um **CRUD (Create, Read, Update, Delete)**, com foco em:
...
- Pesquisa por diversos grupos
- Alteração de modelo, marca, ano e etc
- Exclusão de veículos
- Geração de uma **listagem online em HTML**
- Exportação por vários grupos em formato web
